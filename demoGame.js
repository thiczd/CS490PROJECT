...
function TimerGame() {
    switch (User.GameState) {
        case 0:
            ...
            var randTime = Math.floor((Math.random() * randTime)+1) * 1000;
        ...
        case 2: //Current state if the user has clicked only in the green
        ...
        default:
            returnTime.innerText = "Error: Game Defaulted";
            break;
    }
}
